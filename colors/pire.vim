...
" Last Updated: 2022-12-05 15:34:28
...
if &background ==# 'dark'
  ...
  hi DiffDelete guifg=#5f3f3f guibg=#875f5f gui=NONE cterm=NONE
  hi DiffAdd guifg=NONE guibg=#1c3a1c gui=NONE cterm=NONE
  hi DiffChange guifg=NONE guibg=#303030 gui=NONE cterm=NONE
  hi DiffText guifg=NONE guibg=#6c4f1c gui=NONE cterm=NONE
else
  " Light background
  if (has('termguicolors') && &termguicolors) || has('gui_running')
